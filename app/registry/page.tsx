  ...
  return (
    <div className="container mx-auto bg-black text-white px-4 py-8">
      ...
      <p className="text-center text-gray-200">
        We&apos;ve been building our home together for a while now, so our
        registry is designed to help us enjoy our honeymoon and add a few
        special touches to our home. If you&apos;d like to contribute, you can
        find our registry below. Your love and support are the best gift of all!
      </p>
